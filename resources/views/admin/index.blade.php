...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{ asset('/admin/user') }}"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/adminlte/#"><i class="fa fa-circle-o"></i> Level One</a></li>
            <li class="treeview">
              <a href="/adminlte/#"><i class="fa fa-circle-o"></i> Level One
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="/adminlte/#"><i class="fa fa-circle-o"></i> Level Two</a></li>
                <li class="treeview">
                  <a href="/adminlte/#"><i class="fa fa-circle-o"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="/adminlte/#"><i class="fa fa-circle-o"></i> Level Three</a></li>
                    <li><a href="/adminlte/#"><i class="fa fa-circle-o"></i> Level Three</a></li>
                  </ul>
                </li>
              </ul>
        ...
        <li><a href="/adminlte/https://adminlte.io/docs"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
        <li class="header">LABELS</li>
        <li><a href="/adminlte/#"><i class="fa fa-circle-o text-red"></i> <span>Important</span></a></li>
        <li><a href="/adminlte/#"><i class="fa fa-circle-o text-yellow"></i> <span>Warning</span></a></li>
        <li><a href="/adminlte/#"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="/adminlte/#"><i class="fa fa-dashboard"></i> Home</a></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="/adminlte/#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="/adminlte/#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="/adminlte/#sales-chart" data-toggle="tab">Donut</a></li>
            ...
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <ul class="pagination pagination-sm inline">
                  <li><a href="/adminlte/#">&laquo;</a></li>
                  <li><a href="/adminlte/#">1</a></li>
                  <li><a href="/adminlte/#">2</a></li>
                  <li><a href="/adminlte/#">3</a></li>
                  <li><a href="/adminlte/#">&raquo;</a></li>
                </ul>
              </div>
            </div>
            <!-- /.box-header -->
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="/adminlte/#">Add new event</a></li>
                    <li><a href="/adminlte/#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="/adminlte/#">View calendar</a></li>
                  </ul>
                </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="/adminlte/https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li><a href="/adminlte/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
