...
<html lang="en">
	...
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="{{ asset('template1/images')  }}/favicon.ico">

		<!-- Web Fonts -->
		<link href='{{ asset('template1/webfonts/pacifico.css')  }}' rel='stylesheet' type='text/css'>
		<link href='{{ asset('template1/webfonts/ptserif.css')  }}' rel='stylesheet' type='text/css'>
		<link href='{{ asset('template1/webfonts/raleway.css')  }}' rel='stylesheet' type='text/css'>
		<link href='{{ asset('template1/webfonts/roboto.css')  }}' rel='stylesheet' type='text/css'>

		<!-- Bootstrap core CSS -->
		<link href="{{ asset('template1/bootstrap/css')  }}/bootstrap.css" rel="stylesheet">

		<!-- Font Awesome CSS -->
		<link href="{{ asset('template1/fonts')  }}/font-awesome/css/font-awesome.css" rel="stylesheet">

		<!-- Fontello CSS -->
		<link href="{{ asset('template1/fonts')  }}/fontello/css/fontello.css" rel="stylesheet">

		<!-- Plugins -->
		<link href="{{ asset('template1/plugins')  }}/magnific-popup/magnific-popup.css" rel="stylesheet">
		<link href="{{ asset('template1/css')  }}/animations.css" rel="stylesheet">
		<link href="{{ asset('template1/plugins')  }}/hover/hover-min.css" rel="stylesheet">		
		<!-- Plugins -->
<!-- 		<link href="{{ asset('template1/plugins')  }}/magnific-popup/magnific-popup.css" rel="stylesheet">
		<link href="{{ asset('template1/plugins')  }}/rs-plugin-5/css/settings.css" rel="stylesheet">
		<link href="{{ asset('template1/plugins')  }}/rs-plugin-5/css/layers.css" rel="stylesheet">
		<link href="{{ asset('template1/plugins')  }}/rs-plugin-5/css/navigation.css" rel="stylesheet">
		<link href="css/animations.css" rel="stylesheet">
		<link href="{{ asset('template1/plugins')  }}/owlcarousel2/assets/owl.carousel.min.css" rel="stylesheet">
		<link href="{{ asset('template1/plugins')  }}/owlcarousel2/assets/owl.theme.default.min.css" rel="stylesheet">
		<link href="{{ asset('template1/plugins')  }}/hover/hover-min.css" rel="stylesheet">	
 -->
		...
		<link href="{{ asset('template1/css')  }}/typography-default.css" rel="stylesheet" >

		<!-- Color Scheme (In order to change the color scheme, replace the blue.css with the color scheme that you prefer)-->
		<link href="{{ asset('template1/css')  }}/skins/light_blue.css" rel="stylesheet">
<style>
...
#email_templates .btn-vivid-red:focus { background-color: #b42424; color: #fff; border-color: #b42424; }
		...
		<!-- Custom css --> 
		<link href="{{ asset('template1/css')  }}/custom.css" rel="stylesheet">
	</head>
	...
	<body class="no-trans front-page">
		...
		<div class="page-wrapper">
							...
							<div class="col-md-3 ">
								...
								<div class="header-first clearfix">
									...
									<div id="logo" class="logo">
										<a href="template/index.html"><img id="logo_img" src="{{ asset('template1/images')  }}/logo_light_blue.png" alt="The Project"></a>
									</div>
															...
															<li>
																<div class="row">
																	...
																	<div class="col-lg-4 col-md-3 hidden-sm">
																		...
																		<img src="{{ asset('template1/images')  }}/section-image-3.png" alt="The Project">
																	</div>
																</div>
															</li>
														</ul>
			...
			<!-- banner start -->
			<!-- ================ -->
			<div class="banner dark-translucent-bg" style="background-image:url('{{ asset('intro-images')  }}/intro-banner.jpg');">
				<!-- section start -->
				<!-- ================ -->
				<div class="container">
					<div class="row">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-1.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-38.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-39.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-2.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-3.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-4.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-30.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-34.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-5.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-6.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-7.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-32.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-29.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-33.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-31.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-8.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-9.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-35.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-24.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-25.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-26.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-27.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-36.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-28.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-10.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-11.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-37.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-12.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-13.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box bordered text-center mb-20">
								<img src="{{ asset('intro-images')  }}/demo-15.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-16.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-17.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-18.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-19.jpg" alt="">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-20.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-21.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-22.jpg" alt="">
						...
						<div class="col-sm-3">
							...
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="{{ asset('intro-images')  }}/demo-23.jpg" alt="">
		...
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/jquery.min.js"></script>
		<script type="text/javascript" src="{{ asset('template1/bootstrap')  }}/js/bootstrap.min.js"></script>

		<!-- Modernizr javascript -->
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/modernizr.js"></script>

		<!-- Isotope javascript -->
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/isotope/isotope.pkgd.min.js"></script>
		
		<!-- Magnific Popup javascript -->
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/magnific-popup/jquery.magnific-popup.min.js"></script>
		
		<!-- Appear javascript -->
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/waypoints/jquery.waypoints.min.js"></script>

		<!-- Count To javascript -->
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/jquery.countTo.js"></script>
		
		<!-- Parallax javascript -->
		<script src="{{ asset('template1/plugins')  }}/jquery.parallax-1.1.3.js"></script>

		<!-- Contact form -->
		<script src="{{ asset('template1/plugins')  }}/jquery.validate.js"></script>

		<!-- Background Video -->
		<script src="{{ asset('template1/plugins')  }}/vide/jquery.vide.js"></script>

		<!-- SmoothScroll javascript -->
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/jquery.browser.js"></script>
		<script type="text/javascript" src="{{ asset('template1/plugins')  }}/SmoothScroll.js"></script>
